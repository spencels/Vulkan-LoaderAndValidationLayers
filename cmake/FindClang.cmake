...
find_and_add_clang_library(clangToolingRefactor)
find_and_add_clang_library(clangToolingCore)
...
find_and_add_clang_library(clangASTMatchers)
find_and_add_clang_library(clangAST)
find_and_add_clang_library(clangFormat)
find_and_add_clang_library(clangRewrite)
...
target_link_libraries(clang INTERFACE llvm ${Clang_LIBRARIES} version)